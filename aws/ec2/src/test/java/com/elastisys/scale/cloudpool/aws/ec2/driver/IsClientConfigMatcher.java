...
public class IsClientConfigMatcher extends BaseMatcher<ClientConfiguration> {
	...
	public IsClientConfigMatcher(Integer execptedConnectionTimeout,
			Integer execptedSocketTimeout) {
	...
	public void describeTo(Description description) {
		description.appendText(String.format(
				"ClientConfiguration with connectionTimeout '%d' and socketTimeout '%d'",
				this.expectedConnectionTimeout, this.expectedSocketTimeout));
	}

	public static Matcher<ClientConfiguration> isClientConfig(
			int expectedConnectionTimeout, int expectedSocketTimeout) {
		return new IsClientConfigMatcher(expectedConnectionTimeout,
