...
logconfig="/etc/elastisys/ec2adapter/logback.xml"
julconfig="/etc/elastisys/ec2adapter/logging.properties"
...
# have been set up
authbind --deep ${java} ${JAVA_OPTS} -jar ec2adapter.jar ${SERVER_OPTS}
