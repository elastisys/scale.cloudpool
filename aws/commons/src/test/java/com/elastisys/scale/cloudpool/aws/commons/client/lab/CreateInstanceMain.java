...
public class CreateInstanceMain extends AbstractClient {
    ...
    private static final List<String> securityGroups = Arrays.asList("webserver");
    ...
    public static void main(String[] args) throws Exception {
        logger.info(format("Starting instance in region %s, availability zone %s", region, availabilityZone));

        CreateInstances request = new CreateInstances(AWS_CREDENTIALS, region, new ClientConfiguration(),
                availabilityZone, securityGroups, keyPair, instanceType, imageId, bootScript, 1,
