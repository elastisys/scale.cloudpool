...
public interface Ec2Client {
     ...
     */
    void configure(String awsAccessKeyId, String awsSecretAccessKey, String region, ClientConfiguration clientConfig);
     ...
     */
    List<Instance> getInstances(List<Filter> filters) throws AmazonClientException;
     ...
     *             if the request failed
     */
    void tagResource(String resourceId, List<Tag> tags) throws AmazonClientException;
     ...
     *             if the request failed
     */
    void untagResource(String resourceId, List<Tag> tags) throws AmazonClientException;
