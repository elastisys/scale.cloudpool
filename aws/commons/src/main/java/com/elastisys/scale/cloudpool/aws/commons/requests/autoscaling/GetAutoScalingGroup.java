 ...
 */
public class GetAutoScalingGroup
		extends AmazonAutoScalingRequest<AutoScalingGroup> {
	 ...
	 * @param groupName
	 */
	public GetAutoScalingGroup(AWSCredentials awsCredentials, String region,
			ClientConfiguration clientConfig, String groupName) {
	...
	public AutoScalingGroup call() {
		...
		if (autoScalingGroups.isEmpty()) {
			throw new IllegalArgumentException(
					format("Auto Scaling Group '%s' doesn't exist in region '%s'.",
