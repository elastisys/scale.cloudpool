...
logconfig="/etc/elastisys/awsasadapter/logback.xml"
julconfig="/etc/elastisys/awsasadapter/logging.properties"
...
# have been set up
authbind --deep ${java} ${JAVA_OPTS} -jar awsasadapter.jar ${SERVER_OPTS}
