...
public class TestConfigHandler {
	...
	public void createWithExplicitArguments() {
		ConfigHandler configHandler = new ConfigHandler(this.poolMock,
				storageDir, "testconfig.json");
		assertThat(configHandler.getCloudPoolConfigPath(),
				is(Paths.get(storageDir, "testconfig.json")));
	}
	...
	public void createWithDefaultConfigFileName() {
		ConfigHandler configHandler = new ConfigHandler(this.poolMock,
				storageDir);
		assertThat(configHandler.getCloudPoolConfigPath(), is(Paths.get(
				storageDir, ConfigHandler.DEFAULT_CONFIG_FILE_NAME)));
