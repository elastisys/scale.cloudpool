...
public class TestMembershipStatus {
	...
	public void testBasicSanity() {
		...
		MembershipStatus inactiveNotEvictable = new MembershipStatus(false,
				false);
	...
	public void testHashcode() {
		...
		assertTrue(activeEvictable.hashCode() == new MembershipStatus(true,
				true).hashCode());
		assertTrue(activeNotEvictable.hashCode() == new MembershipStatus(true,
				false).hashCode());
		assertTrue(inactiveEvictable.hashCode() == new MembershipStatus(false,
				true).hashCode());
		assertTrue(inactiveNotEvictable.hashCode() == new MembershipStatus(
		...
		assertFalse(activeEvictable.hashCode() == inactiveNotEvictable
				.hashCode());

		assertFalse(activeNotEvictable.hashCode() == activeEvictable.hashCode());
		assertFalse(activeNotEvictable.hashCode() == inactiveEvictable
				.hashCode());
		assertFalse(activeNotEvictable.hashCode() == inactiveNotEvictable
				.hashCode());

		assertFalse(inactiveEvictable.hashCode() == activeEvictable.hashCode());
		assertFalse(inactiveEvictable.hashCode() == activeNotEvictable
				.hashCode());
		assertFalse(inactiveEvictable.hashCode() == inactiveNotEvictable
				.hashCode());

		assertFalse(inactiveNotEvictable.hashCode() == activeEvictable
				.hashCode());
		assertFalse(inactiveNotEvictable.hashCode() == activeNotEvictable
				.hashCode());
		assertFalse(inactiveNotEvictable.hashCode() == inactiveEvictable
				.hashCode());
	}
	...
	public void testDefault() {
		assertThat(MembershipStatus.defaultStatus(), is(new MembershipStatus(
				true, true)));
	}
	...
	public void testBlessed() {
		assertThat(MembershipStatus.blessed(), is(new MembershipStatus(true,
				false)));
	}
	...
	public void testAwaitingService() {
		assertThat(MembershipStatus.awaitingService(), is(new MembershipStatus(
				false, false)));
	}
