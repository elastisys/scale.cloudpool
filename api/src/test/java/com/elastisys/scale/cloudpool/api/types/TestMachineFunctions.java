...
public class TestMachineFunctions {
    ...
    public void testRequestAge() {
        ...
        final DateTime now = requesttime.plusMillis(millisecondsSinceRequestTime);

        Machine machine = machine("i-1", requesttime, null);

        assertThat(Machine.requestAge(now).apply(machine).get(), is(new Long(millisecondsSinceRequestTime)));
    ...
    public void testInstanceHourStart() {
        ...
        assertThat(Machine.instanceHourStart().apply(machine), is(UtcTime.parse("2013-12-09T08:50:00Z")));
        ...
        assertThat(Machine.instanceHourStart().apply(machine), is(UtcTime.parse("2013-12-09T09:50:00Z")));

        FrozenTime.setFixed(UtcTime.parse("2013-12-09T09:55:00Z"));
        assertThat(Machine.instanceHourStart().apply(machine), is(UtcTime.parse("2013-12-09T09:50:00Z")));

        FrozenTime.setFixed(UtcTime.parse("2013-12-09T10:51:00Z"));
        assertThat(Machine.instanceHourStart().apply(machine), is(UtcTime.parse("2013-12-09T10:50:00Z")));
        ...
        assertThat(Machine.instanceHourStart().apply(machine), is(UtcTime.parse("2013-12-09T10:50:00.500Z")));
    }
    ...
    public void testRemainingInstanceHourTime() {
        ...
        assertThat(Machine.remainingInstanceHourTime().apply(machine),
                is(secondsBetween(UtcTime.now(), machine.getLaunchTime().plusHours(1))));
        ...
        FrozenTime.setFixed(UtcTime.parse("2013-12-09T09:50:00Z"));
        assertThat(Machine.remainingInstanceHourTime().apply(machine),
                is(secondsBetween(UtcTime.now(), machine.getLaunchTime().plusHours(2))));
        FrozenTime.setFixed(UtcTime.parse("2013-12-09T09:55:00Z"));
        assertThat(Machine.remainingInstanceHourTime().apply(machine),
                is(secondsBetween(UtcTime.now(), machine.getLaunchTime().plusHours(2))));
        ...
        FrozenTime.setFixed(UtcTime.parse("2013-12-09T10:51:00Z"));
        assertThat(Machine.remainingInstanceHourTime().apply(machine),
                is(secondsBetween(UtcTime.now(), machine.getLaunchTime().plusHours(3))));
