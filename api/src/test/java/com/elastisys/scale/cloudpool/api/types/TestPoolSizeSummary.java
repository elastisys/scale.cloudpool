...
public class TestPoolSizeSummary {
    ...
    public void basicSanity() {
        ...
        int allocated = 3;
        int active = 2;
        PoolSizeSummary summary = new PoolSizeSummary(timestamp, desiredSize, allocated, active);
    ...
    public void equality() {
        assertThat(new PoolSizeSummary(4, 3, 2), is(new PoolSizeSummary(4, 3, 2)));

        assertThat(new PoolSizeSummary(4, 3, 2), is(not(new PoolSizeSummary(3, 3, 2))));
        assertThat(new PoolSizeSummary(4, 3, 2), is(not(new PoolSizeSummary(4, 2, 2))));
        assertThat(new PoolSizeSummary(4, 3, 2), is(not(new PoolSizeSummary(4, 3, 1))));
    }
