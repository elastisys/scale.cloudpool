...
public class TestRestApiSecurityCertAuth {
    ...
    public void connectWithTrustedCertificate() {
        Client certAuthClient = RestTestUtils.httpsCertAuth(CLIENT_KEYSTORE, CLIENT_KEYSTORE_PASSWORD,
                KeyStoreType.PKCS12);
    ...
    public void connectWithUntrustedCertificate() {
        try {
            Client certAuthClient = RestTestUtils.httpsCertAuth(UNTRUSTED_CLIENT_KEYSTORE,
