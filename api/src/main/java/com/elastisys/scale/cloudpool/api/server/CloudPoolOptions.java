...
public class CloudPoolOptions {
     ...
     */
    public final static String DEFAULT_KEYSTORE_PATH = Resources.getResource("etc/security/server_keystore.p12")
            .toString();
    /** Password to the default SSL key store. */
    public final static String DEFAULT_KEYSTORE_PASSWORD = "pkcs12password";

    public final static String DEFAULT_TRUSTSTORE_PATH = Resources.getResource("etc/security/server_truststore.jks")
            .toString();
    ...
    @Option(name = "--require-cert", usage = "Require SSL clients "
            ...
            + "trusted clients to have their certificates added to the " + "server's trust store.")
