	...
	public static class StateStorageBuilder {
		...
		public StateStorage build() {
			List<String> allFileNames = Arrays
					.asList(this.cachedMachinePoolFileName);
			...
			File cachedMachinePoolFile = new File(this.storageDir,
					this.cachedMachinePoolFileName);
		 ...
		 * @return
		 */
		public StateStorageBuilder withCachedMachinePoolFileName(
				String fileName) {
