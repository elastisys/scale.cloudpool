...
public class PermissiveSshServer {
    static final Logger LOG = LoggerFactory.getLogger(PermissiveSshServer.class);
    ...
    public static void main(String[] args) throws Exception {
        PermissiveSshServer sshServer = new PermissiveSshServer(22222, "src/test/resources/security/serverkey.pem");
        sshServer.start();
