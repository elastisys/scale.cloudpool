...
logconfig="/etc/elastisys/openstackadapter/logback.xml"
julconfig="/etc/elastisys/openstackadapter/logging.properties"
...
# have been set up
authbind --deep ${java} ${JAVA_OPTS} -jar openstackadapter.jar ${SERVER_OPTS}
