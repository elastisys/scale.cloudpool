...
import com.elastisys.scale.cloudadapters.openstack.tasks.RetryUntilAssignedIpAddress;
...
public class AssignFloatingIpRequest extends AbstractNovaRequest<String> {
	...
	private Multimap<String, Address> waitForPrivateIpAddress(
		...
		RetryableRequest<Multimap<String, Address>> retryableRequest = new RetryableRequest<>(
				new ServerIpAddressRequester(serverApi, server.getId()),
				new RetryUntilAssignedIpAddress(10, 6000), taskName);
