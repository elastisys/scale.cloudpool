package com.elastisys.scale.cloudpool.openstack.lab;
...
import com.elastisys.scale.cloudpool.openstack.requests.lab.AbstractClient;
...
public class RunPool extends AbstractClient {
	...
	public static void main(String[] args) throws Exception {
		...
		BaseCloudPoolConfig config = new BaseCloudPoolConfig(
				new CloudPoolConfig("openstack-cluster",
	...
	private static JsonObject openstackScalingGroupConfig() {
		OpenStackPoolDriverConfig clientConfig = new OpenStackPoolDriverConfig(
