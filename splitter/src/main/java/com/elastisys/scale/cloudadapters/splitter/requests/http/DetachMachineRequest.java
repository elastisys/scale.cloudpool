 ...
 * {@code POST /pool/<instance>/detach} against a cloud adapter.
 */
public class DetachMachineRequest extends CloudAdapterRequest<Void> {
	/** Machine to request cloud adapter to detach. */
	private final String machineId;
	/** {@code true} if cloud adapter should decrement its desired pool size. */
	private final boolean decrementDesiredSize;

	public DetachMachineRequest(PrioritizedCloudAdapter cloudAdapter,
