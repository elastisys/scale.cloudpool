...
public class PodPoolConfig {
    ...
    /**
     * The <a href="http://kubernetes.io/docs/user-guide/namespaces/">
     * Kubernetes namespace</a> that the ReplicationController being managed
     * lives in.
     *
     * @return
     */
    ...
    public void validate() throws IllegalArgumentException {
        checkArgument(this.replicationController != null, "podPool: missing replicationController name");
    }
}
