...
# Logging
LOG_CONFIG=${LOG_CONFIG:-/etc/elastisys/gkepool/logback.xml}
JUL_CONFIG=${JUL_CONFIG:-/etc/elastisys/gkepool/logging.properties}
...
STORAGE_DIR=${STORAGE_DIR:-/var/lib/elastisys/gkepool}
