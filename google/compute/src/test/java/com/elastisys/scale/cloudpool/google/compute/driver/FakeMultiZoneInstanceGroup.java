...
public class FakeMultiZoneInstanceGroup {
    ...
    public static final String INSTANCE_BASE_NAME = "webserver";
    ...
    public InstanceGroupManager instanceGroupManager() {
        ...
        String instanceGroupUrl = InstanceGroupUrl
                .managedRegional(project(), region(), provisioningTemplate().getInstanceGroup()).getUrl();
        return new InstanceGroupManager().setName(provisioningTemplate().getInstanceGroup())
                .setBaseInstanceName(INSTANCE_BASE_NAME).setTargetSize(this.targetSize)
    ...
    public List<Instance> instances() {
        ...
        for (int i = 1; i <= this.numRunning; i++) {
            ...
            memberInstances.add(instance(INSTANCE_BASE_NAME + "-" + i, "RUNNING", privateIp, publicIp));
        }
    ...
    private String instanceUrl(String instanceShortName, String zoneName) {
        return InstanceUrl.from(project(), zoneName, instanceShortName).getUrl();
    }
