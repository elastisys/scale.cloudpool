...
public interface VsphereClient {
     ...
     *
     * @param vsphereApiSettings
     *            Information about the Vcenter server itself.
     ...
     *
     * @param count
     *            Number of virtual machines to launch.
     * @param tags
     ...
     *
     * @param id
     *            Name of the virtual machine which should be tagged.
     * @param tags
     *            List of tags to attach to the virtual machine.
     */
     ...
     *
     * @param id
     *            Name of the virtual machine which should be untagged.
     * @param tags
     *            List of tags to remove from the virtual machine.
     */
